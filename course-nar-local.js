...
window.ATV_COURSE_MASTER["門別"] = {
    DIRT: {
        ...
        1500: { locFactor: -0.06, cFactor: 0.026, staminaPenalty: 1.10, classes: { "S":"03", "A":"03", "B":"03", "C":"03", "D":"03", "E":"03", "F":"03" } },
        1600: { locFactor: -0.06, cFactor: 0.026, staminaPenalty: 1.10, classes: { "S":"03", "A":"03", "B":"03", "C":"03", "D":"03", "E":"03", "F":"03" } },
        ...
        2000: { locFactor: -0.06, cFactor: 0.026, staminaPenalty: 1.15, classes: { "S":"04", "A":"04", "B":"04", "C":"03", "D":"03", "E":"03", "F":"03" } }
    }
};
...
window.ATV_COURSE_MASTER["盛岡"] = {
    ...
    DIRT: {
        ...
        1400: { locFactor: -0.03, cFactor: 0.026, staminaPenalty: 1.00, classes: { "S":"04", "A":"04", "B":"04", "C":"03", "D":"03", "E":"03", "F":"03" } },
        ...
        2000: { locFactor: -0.03, cFactor: 0.024, staminaPenalty: 1.05, classes: { "S":"03", "A":"03", "B":"03", "C":"03", "D":"02", "E":"02", "F":"02" } }
    }
};
...
window.ATV_COURSE_MASTER["水沢"] = {
    DIRT: {
        ...
        2000: { locFactor: -0.04, cFactor: 0.026, staminaPenalty: 1.05, classes: { "S":"02", "A":"02", "B":"02", "C":"02", "D":"02", "E":"01", "F":"01" } }
    }
};
...
window.ATV_COURSE_MASTER["名古屋"] = {
    DIRT: {
        ...
        1400: { locFactor: -0.07, cFactor: 0.030, staminaPenalty: 1.15, classes: { "S":"03", "A":"03", "B":"03", "C":"03", "D":"02", "E":"02", "F":"02" } },
        ...
        2100: { locFactor: -0.07, cFactor: 0.028, staminaPenalty: 1.15, classes: { "S":"02", "A":"02", "B":"02", "C":"02", "D":"02", "E":"01", "F":"01" } }
    }
};
...
window.ATV_COURSE_MASTER["笠松"] = {
    DIRT: {
        ...
        1580: { locFactor: -0.07, cFactor: 0.031, staminaPenalty: 1.10, classes: { "S":"03", "A":"03", "B":"03", "C":"03", "D":"02", "E":"02", "F":"02" } },
        1600: { locFactor: -0.07, cFactor: 0.030, staminaPenalty: 1.10, classes: { "S":"03", "A":"03", "B":"03", "C":"03", "D":"02", "E":"02", "F":"02" } },
        1800: { locFactor: -0.07, cFactor: 0.030, staminaPenalty: 1.10, classes: { "S":"02", "A":"02", "B":"02", "C":"02", "D":"02", "E":"01", "F":"01" } },
...
window.ATV_COURSE_MASTER["高知"] = {
    DIRT: {
        ...
        2100: { locFactor: -0.08, cFactor: 0.030, staminaPenalty: 1.25, classes: { "S":"02", "A":"02", "B":"02", "C":"02", "D":"02", "E":"01", "F":"01" } }
    }
};
